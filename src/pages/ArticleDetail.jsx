      ...
      <div className="row">
        ...
        <div className="col-md-6">
          <div className="card">
            ...
            <div className="card-body">
              <img src={state.image} className="image-fluid rounded mb-3" alt={state.title} />
              <label className="d-block" htmlFor="image">文章圖片連結</label>
              <input type="text" className="form-control" value={state.image} id="image" onChange={handleChange} />
            </div>
          </div>
        </div>
      </div>
